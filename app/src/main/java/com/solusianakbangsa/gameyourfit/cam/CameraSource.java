...
package com.solusianakbangsa.gameyourfit.cam;
...
public class CameraSource {
  ...
  public static SizePair getCameraPreviewSizePair(Context context, int cameraId) {
    if (cameraId == CameraSource.CAMERA_FACING_BACK
            || cameraId == CameraSource.CAMERA_FACING_FRONT) return null;
  ...
  private Camera createCamera() throws IOException {
    ...
    SizePair sizePair = CameraSource.getCameraPreviewSizePair(activity, requestedCameraId);
    if (sizePair == null) {
      sizePair =
          selectSizePair(
              camera,
    ...
    Log.i(TAG, "Camera FPS Range: " + Arrays.toString(previewFpsRange));
...
//    Log.i(TAG, "Exposure: " + parameters.getExposureCompensation());
//
//    Log.i(TAG, "Flatten: " + parameters.flatten());
//    Log.i(TAG, "Flatten: " + parameters.get("iso-values"));
//    Log.i(TAG, "Flatten: " + parameters.get("iso"));
...
//    }
  ...
  private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
    ...
    Log.i(TAG, "Display rotation is: " + rotation);
    Log.i(TAG, "Camera face is: " + cameraInfo.facing);
    Log.i(TAG, "Camera rotation is: " + cameraInfo.orientation);
    // This value should be one of the degrees that ImageMetadata accepts: 0, 90, 180 or 270.
    Log.i(TAG, "RotationDegrees is: " + this.rotationDegrees);
    Log.i(TAG, "displayAngle is: " + displayAngle);
